...
<html lang="en">
  ...
  <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6MTQ1ODA4ODE2OjJjODRiY2M4NTk5MDFmZmYxMTE2MzhhZTdkMDg2ZDVlZDk4MWVlMjc4ZmM4YjdiOGNhNTM1MzVmMGQzNjE2ZWY=--4c9f6e8aebdd31a360a57ece4daa09bb96460ae2">
  <meta name="pjax-timeout" content="1000">
  <link rel="sudo-modal" href="/sessions/sudo_modal">
  <meta name="request-id" content="7AF7:7FAC:3A47DD:5CFF6F:58DBA4AD" data-pjax-transient>
...
<meta content="collector.githubapp.com" name="octolytics-host" /><meta content="github" name="octolytics-app-id" /><meta content="https://collector.githubapp.com/github-external/browser_event" name="octolytics-event-url" /><meta content="7AF7:7FAC:3A47DD:5CFF6F:58DBA4AD" name="octolytics-dimension-request_id" /><meta content="8148855" name="octolytics-actor-id" /><meta content="lfsoftware13" name="octolytics-actor-login" /><meta content="7aa352f6735d8123adc4028147a4c8553012f70e5c7872d2bdf98cb3c7cf4b98" name="octolytics-actor-hash" />
<meta content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" name="analytics-location" />
  ...
  <meta name="user-login" content="lfsoftware13">

      <meta name="expected-hostname" content="github.com">
    <meta name="js-proxy-site-detection-payload" content="ZTRiMTEzNjVhOWY0ZmE1NWUyMmY5YzczNDBmMzM4NDA3YTkxNzNiYWU1YzAxYjE2MmE1MjM2N2Y4NDlmNjg3ZHx7InJlbW90ZV9hZGRyZXNzIjoiMjIxLjYuNDAuMTc2IiwicmVxdWVzdF9pZCI6IjdBRjc6N0ZBQzozQTQ3REQ6NUNGRjZGOjU4REJBNEFEIiwidGltZXN0YW1wIjoxNDkwNzg5NTU4LCJob3N0IjoiZ2l0aHViLmNvbSJ9">


  <meta name="html-safe-nonce" content="f598e5ef088c15a2db0e8066550c830b86ea8a00">
...
<ul class="header-nav user-nav float-right" id="user-links">
  <li class="header-nav-item">
    ...
    <a href="/notifications" aria-label="You have no unread notifications" class="header-nav-link notification-indicator tooltipped tooltipped-s js-socket-channel js-notification-indicator " data-channel="notification-changed:8148855" data-ga-click="Header, go to notifications, icon:read" data-hotkey="g n">
...
<a class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <li class="header-nav-item dropdown js-menu-container">
    <a class="header-nav-link name tooltipped tooltipped-sw js-menu-target" href="/lfsoftware13"
       aria-label="View profile and more"
       data-ga-click="Header, show menu, icon:avatar">
      <img alt="@lfsoftware13" class="avatar" src="https://avatars2.githubusercontent.com/u/8148855?v=3&amp;s=40" height="20" width="20">
      <span class="dropdown-caret"></span>
    </a>
    ...
    <div class="dropdown-menu-content js-menu-content">
      <div class="dropdown-menu dropdown-menu-sw">
        <div class="dropdown-header header-nav-current-user css-truncate">
          Signed in as <strong class="css-truncate-target">lfsoftware13</strong>
        </div>

        <div class="dropdown-divider"></div>

        <a class="dropdown-item" href="/lfsoftware13" data-ga-click="Header, go to profile, text:your profile">
          Your profile
        </a>
        <a class="dropdown-item" href="/lfsoftware13?tab=stars" data-ga-click="Header, go to starred repos, text:your stars">
          Your stars
        </a>
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="logout-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="fmgSqSh66gcdKJWDSRrJ7EldXvuVoF1fIb90ZTTS8/mGK9hKS+of6JHUl3gR1X7uWJSDH8F/T2xacEeJoc/kVA==" /></div>
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="sr-only right-0" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="wtOBvXkx11j7LV6CAzh5HKPJBgaUp4/crPGwh0NdUhQ6kEteGqEit3fRXHlb984esgDb4sB4ne/XPoNr1kBFuQ==" /></div>
      <button type="submit" class="dropdown-item dropdown-signout" data-ga-click="Header, sign out, icon:logout">
        Sign out
      </button>
</form>  </div>
  ...
  <li>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="IEnJJOzvVDAtCXebVu9j9uOCQmuo8gPoBBRGpTyI3hKAn0KUyvuA8Ziep4PMBqq27dEX6VkLqfaE1lOkBDIa0Q==" /></div>      <input class="form-control" id="repository_id" name="repository_id" type="hidden" value="1092277" />
        ...
        <div class="select-menu js-menu-container js-select-menu">
          ...
          <a class="social-count js-social-count"
            ...
            aria-label="491 users are watching this repository">
            491
          </a>
  ...
  <li>
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/douglascrockford/JSON-js/unstar" class="starred" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="I4rC4ZVgnAiTLwTaJWOoj5gjLW7m76j7Gp5Q/dFtc3DOlCvCuBpA33zNKA3oJhxxfJrLLHmj+rZ4FUwHjUgk1Q==" /></div>
      <button
        type="submit"
        ...
        <a class="social-count js-social-count" href="/douglascrockford/JSON-js/stargazers"
           aria-label="6747 users starred this repository">
          6,747
        </a>
</form>
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/douglascrockford/JSON-js/star" class="unstarred" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="Saihyq/NTA/6sGtOtmRFEVorWIFdwa+/OksB15M9jyDvwmAlQVfnI1wMMUgpn05PaLbJaw07Jzb3Q4S+GlV7zQ==" /></div>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
  ...
  <li>
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/douglascrockford/JSON-js/fork" class="btn-with-count" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="C9MY8KL1cvuuswHK7+qTaXgYbssok+lPWi9PZeNs4HSbC2UlVAsgaviMmYlCCOv7eyBqwPO2hIpOnhEqdcx1/Q==" /></div>
            <button
                type="submit"
    ...
    <a href="/douglascrockford/JSON-js/network" class="social-count"
       aria-label="3873 users forked this repository">
      3,873
    </a>
  </li>
</ul>
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      ...
      <a href="/douglascrockford/JSON-js/commits/master/json2.js" class="btn btn-sm BtnGroup-item" rel="nofollow">History</a>
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/douglascrockford/JSON-js/edit/master/json2.js" class="inline-form js-update-url-with-hash" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="ZRIHPCv08+I7FqnqDhH7pn6zNZb6Cb/pSd1C8o4qQ1Ps1b3JxI2Y4CLxL+q9+Fdj8tYfLFny6K9o8qmX0b9//Q==" /></div>
          <button class="btn-octicon tooltipped tooltipped-nw" type="submit"
            aria-label="Fork this project and edit the file" data-hotkey="e" data-disable-with>
            <svg aria-hidden="true" class="octicon octicon-pencil" height="16" version="1.1" viewBox="0 0 14 16" width="14"><path fill-rule="evenodd" d="M0 12v3h3l8-8-3-3-8 8zm3 2H1v-2h1v1h1v1zm10.3-9.3L12 6 9 3l1.3-1.3a.996.996 0 0 1 1.41 0l1.59 1.59c.39.39.39 1.02 0 1.41z"/></svg>
          </button>
</form>        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/douglascrockford/JSON-js/delete/master/json2.js" class="inline-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="NmX+slb0yPgboVOqXUQ3dZm4ZxVuxYAZzmu+KCJITTrINw10x2gIY29yIIzyw85iZ59Z7U37MeVFgo3T06X90Q==" /></div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2017 <span title="0.12150s from github-fe145-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
